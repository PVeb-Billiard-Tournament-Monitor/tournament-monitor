...
-- четвртак, 29. децембар 2016. 00:34:11 CET
...
START TRANSACTION;
USE `billiard_db`;
INSERT INTO `billiard_db`.`hosting_tournament` (`date`, `billiard_club_id`, `name`, `entry_fee`, `prize`, `tournament_type`, `tournament_key`, `active`) VALUES ('NOW()', 1, 'Neko ime', 22, 33, 'Drzavni', 'proba123', true);
