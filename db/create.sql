...
-- уторак, 10. јануар 2017. 03:47:30 CET
...
START TRANSACTION;
USE `billiard_db`;
INSERT INTO `billiard_db`.`hosting_tournament` (`date`, `billiard_club_id`, `name`, `entry_fee`, `prize`, `tournament_type`, `tournament_key`, `active`, `lock`) VALUES ('NOW()', 1, 'bla bla', 0, 0, 'Drzavni', 'proba123', true, DEFAULT);
