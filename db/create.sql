...
-- недеља, 08. јануар 2017. 20:46:21 CET
...
INSERT INTO `billiard_db`.`player` (`id`, `name`, `last_name`, `email`, `phone`, `img_link`) VALUES (DEFAULT, 'Jovan', 'Jovanovic', 'jovan.jovanovic@ptt.yu', '+3811232346', NULL);
...
START TRANSACTION;
USE `billiard_db`;
INSERT INTO `billiard_db`.`playing_tournament` (`player_id`, `tournament_date`, `billiard_club_id`, `tournament_type`, `next_round`) VALUES (1, 'NOW()', 1, 'Drzavni', DEFAULT);
INSERT INTO `billiard_db`.`playing_tournament` (`player_id`, `tournament_date`, `billiard_club_id`, `tournament_type`, `next_round`) VALUES (2, 'NOW()', 1, 'Drzavni', DEFAULT);
INSERT INTO `billiard_db`.`playing_tournament` (`player_id`, `tournament_date`, `billiard_club_id`, `tournament_type`, `next_round`) VALUES (3, 'NOW()', 1, 'Drzavni', DEFAULT);
INSERT INTO `billiard_db`.`playing_tournament` (`player_id`, `tournament_date`, `billiard_club_id`, `tournament_type`, `next_round`) VALUES (4, 'NOW()', 1, 'Drzavni', DEFAULT);
